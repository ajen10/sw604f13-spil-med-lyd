...
public class Bump extends GameObject implements IWorkable, IDrawable {
	...
	public void Draw(GL10 gl, GameRenderer spriteBatcher) {
		...
		spriteBatcher.draw(gl, R.drawable.bump, new Rect(0, 0, 100, 100), new Rect(150, 150, 250, 250));
	}
